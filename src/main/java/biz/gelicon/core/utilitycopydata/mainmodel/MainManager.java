...
public class MainManager {
    ...
    public MainManager(Integer managerId, Integer workerId, Integer errortransittypeId, Integer projectId, Integer applicationId, Integer projectaccountId, Integer projectaccountingworkId, Integer departmentId) {
        this.managerId = managerId;
        this.workerId = workerId;
        this.errortransittypeId = errortransittypeId;
        this.projectId = projectId;
