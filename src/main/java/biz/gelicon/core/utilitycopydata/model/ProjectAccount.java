...
public class ProjectAccount {
    ...
    public ProjectAccount(Integer projectaccountid, Integer clientid, Integer projectaccounttypeId, String projectaccountName, Integer projectaccountStatus, Integer projectaccountreportId, String projectaccountCode, Integer workerId) {
        this.projectaccountid = projectaccountid;
        this.clientid = clientid;
        this.projectaccounttypeId = projectaccounttypeId;
        this.projectaccountName = projectaccountName;
