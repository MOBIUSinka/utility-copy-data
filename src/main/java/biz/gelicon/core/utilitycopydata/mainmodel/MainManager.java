...
public class MainManager {
    ...
    public MainManager(Integer managerId, Integer worker_id, Integer errortransittype_id, Integer project_id, Integer application_id, Integer projectaccount_id, Integer projectaccountingwork_id, Integer department_id) {
        this.managerId = managerId;
        this.worker_id = worker_id;
        this.errortransittype_id = errortransittype_id;
        this.project_id = project_id;
