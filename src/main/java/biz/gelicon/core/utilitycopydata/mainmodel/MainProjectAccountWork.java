...
public class MainProjectAccountWork {
    @Id
    ...
    public MainProjectAccountWork(Integer projectaccountingworkId, Integer projectaccountId, String projectaccountworkName, Integer projectaccountworkStatus, Integer projectaccountworkReportId) {
        this.projectaccountingworkId = projectaccountingworkId;
        this.projectaccountId = projectaccountId;
        this.projectaccountworkName = projectaccountworkName;
        this.projectaccountworkStatus = projectaccountworkStatus;
